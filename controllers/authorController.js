...
exports.author_detail = function (req, res, next) {
    ...
    async.parallel({
        ...
        results.author_books.forEach(function (bookObj){
...
exports.author_create_get = function (req, res, next) {
    res.render('author_form', { title: 'Create Author', action_type: 'Create' });
};
...
exports.author_create_post = [
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            res.render('author_form', { title: 'Create Author', action_type: 'Create', author: author, errors: errors.array() });
            return;
        }
        else {
...
exports.author_update_get = function (req, res, next) {
    ...
    Author.findById(req.params.id, function (err, author) {
        ...
        // Success.
        res.render('author_form', { title: 'Update Author', action_type: 'Update', author: author });
...
exports.author_update_post = [
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            res.render('author_form', { title: 'Update Author', action_type: 'Update', author: author, errors: errors.array() });
            return;
        }
        else {
